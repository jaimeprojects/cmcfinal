...
//    scan.close();
  ...
  public void addUser(String first, String last, String user, String password,char type, char  status)
  {
	  Account ac = new Account(first,last,user,password,type,status);
	  dbc.addUser(ac);
  }
