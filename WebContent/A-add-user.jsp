        ...
        <section class="clean-block payment-form dark">
            <div class="container">
                <div class="block-heading">
                    <h2 style="color:rgb(255,255,255);font-family:'Alegreya SC', serif;">Create A New User</h2>
                    ...
                    <div class="products" style="background-color:rgba(247,251,255,0.5);">
                        ...
                        <div class="item">
                            <div class="form-row" style="margin:8px;">
                                ...
                                <div class="col"><input class="form-control" type="text" style="background-color:#cad9e7;font-family:'Alegreya SC', serif;" ></div>
                            </div>
                            <div class="form-row" style="margin:8px;">
                                <div class="col">
                            ...
                            <div class="form-row" style="margin:8px;">
                                ...
                                <div class="col"><input class="form-control" type="text" style="background-color:#cad9e7;font-family:'Alegreya SC', serif;" placeholder="u or a"></div>
                                </div>
                            </div>
                            <div class="form-row" style="margin:8px;">
                                <div class="col">
                            	 ...
                            	 <div class="col"><input class="form-control" type="text" style="background-color:#cad9e7;font-family:'Alegreya SC', serif;" placeholder="Y or N"></div>
                                </div>
                        </div>
                    </div>
                    <div class="card-details" style="background-color:rgba(255,255,255,0.43);">
                    <button class="btn btn-primary" type="submit" style="width:214px;color:rgb(255,255,255);background-color:rgb(187,107,60);font-family:Montserrat, sans-serif;">Create User</button>
                    <a class="btn btn-primary"  href="admin-home.jsp" type="submit" style="width:214px;color:rgb(255,255,255);background-color:rgb(187,107,60);font-family:Montserrat, sans-serif;">Cancel</a></div>
                </form>
            </div>
        </section>
    </main>
